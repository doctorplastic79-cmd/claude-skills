...
Ce ne sono due, con portata diversa: `nas-synology` gestisce il NAS, mentre
`synology-nas-access` si limita a leggerlo attraverso un canale dedicato.
Convivono, e vanno tenute separate proprio perche' concedono accessi diversi.

### `nas-synology` — gestione completa
...
### `synology-nas-access` — sola lettura
